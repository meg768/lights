...
//var matrix = module.exports = new Matrix('http://app-o.se/matrix-64x32', [ClockAnimation, SolarAnimation, AvanzaAnimation, ClockAnimation, WeatherAnimation, ClockAnimation, NewsAnimation]);
var matrix = module.exports = new Matrix('http://app-o.se/matrix-64x32', [ClockAnimation, SolarAnimation]);
